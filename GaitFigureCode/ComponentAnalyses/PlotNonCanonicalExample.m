% PlotNonCanonicalExample.m: This script gathers the data for plotting a
% single non-canonical example from the dataset
...
subplot(3,1,2);
hold on;
% plot(time, singleFly.translationalSpeed_mmPerSec, 'linestyle', '-', 'LineWidth', 2, 'marker', 'none', 'color', colors_all(1,:));
